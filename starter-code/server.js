...
app.get('/new', function(request, response) {
  ...
  // 1. number 5 on the diagram.
  // 2. articleView.initNewArticlePage
  // 3. it invoke the new.html page and give us access to the form.
  // 4. update
...
app.get('/articles', function(request, response) {
  ...
  // 1. Number Three!
  // 2. Article.fetchAll
  // 3. It invokes Article.loadAll to post the requested articles.
  // 4. Read!
...
app.post('/articles', function(request, response) {
  ...
  // 3. No, it just sends it up to the DB.
  // 4. Update
  client.query(
    `INSERT INTO
...
app.delete('/articles/:id', function(request, response) {
  ...
  // 3. It doesn't directly call any other function.
  // 4. DESTROY!
...
// This Is an invocation to create the table if it doesn't exist and load it with the articles in our Database
loadDB();
...
function loadArticles() {
  ...
  // 1. Number Three!
  // 2. Article.loadAll
  // 3. It calls on the Article constructor to populate the information.
  // 4. READ!
...
function loadDB() {
  ...
  // 1. Number Four!
  // 2. Article.fetchAll and Article.loadAll
  // 3. It utilizes the article constructor again.
  // 4. READ!
